...
module.exports = function zipkinClient(tracer, Memcached) {
  var serviceName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'unknown';
  var remoteServiceName = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'memcached';
